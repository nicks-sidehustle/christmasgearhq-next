...
export const metadata: Metadata = {
  title: 'Privacy Policy - Smart Home Explorer',
  description: 'Privacy policy and data handling practices for Smart Home Explorer blog.',
};
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <div className="prose max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                Smart Home Explorer participates in affiliate marketing programs, including the Amazon Associates Program.
              ...
              <p className="text-gray-700">
                ...
                genuine evaluation and research.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="bg-blue-50 p-4 rounded-lg mb-4">
                <h4 className="font-medium text-blue-900 mb-2">Do Not Sell My Personal Information</h4>
              ...
              <p className="text-gray-700 text-sm">
                ...
                <a href="mailto:privacy@smarthomeexplorer.com" className="text-blue-600 hover:text-blue-800">
                  privacy@smarthomeexplorer.com
                </a>{' '}
